...
namespace UEManifestReader.Objects
{
    public readonly struct FChunkInfo : IEquatable<FChunkInfo>
    {
        ...
        {
            get;
        } // base type: ulong (making it a string in order for it to be directly usable to download purposes for example)
        ...
        {
            get;
        } // base type: byte (making it a string in order for it to be directly usable to download purposes for example)
