namespace UEManifestReader.Enums
{
    ...
    public enum EFeatureLevel
    {
        ...
        /// <summary>
        ///     Manifest stores group number for each chunk/file data for reference so that external readers don't need to know how
        ///     to calculate them.
        /// </summary>
        ...
        /// <summary>
        ///     Temporary level where manifest can reference chunks with dynamic window size, but did not serialize them. Chunks
        ///     from here onwards are stored in ChunksV4.
        /// </summary>
